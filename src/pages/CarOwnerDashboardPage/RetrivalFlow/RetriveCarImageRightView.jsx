...
const RetriveCarImageRightView = () => {
   ...
   const handleTakeLeftView = () => {
    localStorage.setItem('rightView-img', image)
     navigate('/carowner/retrival/leftview')
   }
...
export default RetriveCarImageRightView