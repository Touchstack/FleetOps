...
const RetriveCarImageLeftView = () => {
   ...
   const handleTakeBackView = () => {
    localStorage.setItem('leftView-img', image)
     navigate('/carowner/retrival/backview')
   }
...
export default RetriveCarImageLeftView