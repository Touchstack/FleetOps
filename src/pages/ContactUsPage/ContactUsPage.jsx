        ...
        >
          <div className="container flex flex-col justify-center self-center lg:6/12 md:9/12 sm:10/12 ">
            ...
            <p className="text-white self-center text-[19px] lg:w-7/12 md:w-9/12 sm:w-10/12 w-10/12 font-Regular">
              ...
              interested in what we do, your questions, comments, and feedback
              are welcome. Here's how you can get in touch with us:.
            </p>
          </div>
        </div>

        <div className="bg-white text-center mt-10 mb-10 p-8">
          <h1 className="font-Bold text-[#000] text-[36px]">
            General Inquiries
          </h1>
          ...
          <p className="mb-4 font-Regular text-[19px]">
            You can also send us a whatsapp message and we will <br /> respond
            as soon as possible.
          </p>
          <button className="bg-[#38B908] text-white rounded-lg p-5 px-8 py-3">
